...
export class MemberFormComponent implements OnInit {
  ...
  savePut(member: Member) {
    ...
    this.httpService
      ...
      .put(`${environment.membersUrlApi}/${this.aMember.id}`, member)
      .subscribe((result) => {
  ...
  savePost(member: Member) {
    ...
    this.httpService
      ...
      .post(environment.membersUrlApi, member)
      .subscribe((result) => {
  ...
  loadEntity() {
    ...
    // const url: string = environment.apiUrl + "/members/" + this.route.snapshot.params["idMember"];
    const url: string = `${environment.membersUrlApi}/${this.route.snapshot.params["idMember"]}`;
